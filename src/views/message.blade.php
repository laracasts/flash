        ...
        <div class="row">
          <div class="text-center">
              ...
              <?php $flash_notification_messages = Session::get('flash_notification.message');
                ...
                @if(is_array($flash_notification_messages) || is_object($flash_notification_messages))
                  ...
                  @endforeach
                @else
                  <div class="alert alert-{{ $flash_notification_levels }}"
                      style="border-radius:0;border-left:0;border-right:0;">
                      <button type="button" class="close"
                        data-dismiss="alert" aria-hidden="true">
                        <i class="lnr lnr-cross"></i>
                      </button>
                      {!! $flash_notification_messages !!}
                  </div>
